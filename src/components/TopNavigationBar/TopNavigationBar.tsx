    ...
    <>
      ...
      <nav
        className={classNames(
          !transparent && 'bg-transparent shadow-sm border-amber-200',
          'relative'
        )}
      >
        <div className="mx-auto py-4 px-4 sm:px-6 lg:px-8 w-7/8">
            ...
            <div className="hidden lg:flex lg:items-center">
              {currentUser ? (
                ...
                <>
                  <button
                    onClick={() => signIn()}
                    className="dark:text-dark-high-emphasis relative inline-flex items-center rounded-4xl border border-transparent px-6 py-2 text-base leading-6 font-medium text-gray-500 bg-gray-800"
                  >
                    Login
                  </button>
